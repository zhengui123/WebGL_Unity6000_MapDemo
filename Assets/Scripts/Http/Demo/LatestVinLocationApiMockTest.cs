...
{
    /// <summary>全国视图用：山东 + 黑龙江各若干测试点（x=经度，y=纬度）。</summary>
    public const string SampleResponseJson =
        "{\"code\":10000,\"msg\":\"操作成功！\",\"data\":[" +
        // 山东
        "{\"x\":117.120000,\"y\":36.650000}," +
        "{\"x\":120.380000,\"y\":36.070000}," +
        "{\"x\":118.790000,\"y\":36.880000}," +
        "{\"x\":119.460000,\"y\":35.420000}," +
        // 黑龙江
        "{\"x\":126.530000,\"y\":45.800000}," +
        "{\"x\":123.950000,\"y\":47.350000}," +
        "{\"x\":130.350000,\"y\":46.800000}," +
        "{\"x\":128.810000,\"y\":47.720000}" +
        "]}";
    ...
    public void ApplyMockResponse()
    {
        ...
        Debug.Log(
            $"[LatestVinLocationApiMockTest] 已应用模拟热力点 → provinceCode={_provinceCode}");
    }
