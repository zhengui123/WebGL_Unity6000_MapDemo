...
Shader "Devdog/UI/DigitalGlitchUI"
{
	Properties
	{
		...
		[HDR] _GlitchColor ("抖动色", Color) = (0.2, 0.65, 1, 1)
		_GlitchColorIntensity ("抖动色强度", Float) = 3
...
#include "UnityUI.cginc"
	...
	v2f vert(appdata_t IN)
	{
		...
		float glitchDrive = noiseOffset.x * strength * _GlitchColorIntensity;
		OUT.color.rgb += _GlitchColor.rgb * glitchDrive;
